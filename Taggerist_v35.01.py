...
class TaggeristMainWindow(QMainWindow):
    def __init__(self):
        ...
        try:
            import PySide6
            with open('Taggerist_v35.01-buglog.txt', 'a') as f:
                f.write("--- Taggerist v35.01 startup ---\n")
    ...
    def update_window_title(self):
        if self.current_file:
            self.setWindowTitle(f"Taggerist v35.01 - {os.path.basename(self.current_file)}")
        else:
            self.setWindowTitle("Taggerist v35.01")
...
class TaggeristList(QFrame):
    ...
    def select_taglist(self, number):
        ...
        with open('Taggerist_v35.01-buglog.txt', 'a') as dbg:
    ...
    def setup_ui(self):
        layout = QVBoxLayout(self)
        with open('Taggerist_v35.01-buglog.txt', 'a') as debug_file:
        ...
        self.skip_btn.setStyleSheet("color: #fff; background-color: #e8752a; border: 1px solid #FFFFCC; padding: 6px 18px; font-weight: bold;")
        ...
        top_grid.addWidget(clear_reduce_widget, 3, 0)
        ...
        top_grid.addWidget(self.search_edit, 3, 1)
