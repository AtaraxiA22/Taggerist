...
# Taggerist v33.15: Fixed TF sort, Process/Skip buttons, and highlighting
...
class TaggeristMainWindow(QMainWindow):
    ...
    def update_window_title(self):
        if self.current_file:
            self.setWindowTitle(f"Taggerist v33.15 - {os.path.basename(self.current_file)}")
        else:
            self.setWindowTitle("Taggerist v33.15")
...
class TaggeristList(QFrame):
    ...
    def setup_ui(self):
        ...
        with open('Taggerist_v33.15-buglog.txt', 'a') as debug_file:
...
class TaggeristFiles(QFrame):
    ...
    def handle_single_click(self, item):
        try:
            ...
            with open('Taggerist_v33.15-buglog.txt', 'a') as f:
