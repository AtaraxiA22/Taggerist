...
# Taggerist v34.02: Fix startup crash - taglist loading now self-contained in TL; record selected taglist number
...
class TaggeristMainWindow(QMainWindow):
    ...
    def update_window_title(self):
        if self.current_file:
            self.setWindowTitle(f"Taggerist v34.02 - {os.path.basename(self.current_file)}")
        else:
            self.setWindowTitle("Taggerist v34.02")
...
class TaggeristList(QFrame):
    ...
    def setup_ui(self):
        ...
        with open('Taggerist_v34.02-buglog.txt', 'a') as debug_file:
...
class TaggeristFiles(QFrame):
    ...
    def handle_single_click(self, item):
        try:
            ...
            with open('Taggerist_v34.02-buglog.txt', 'a') as f:
