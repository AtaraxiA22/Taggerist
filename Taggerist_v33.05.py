...
# Taggerist v33.05: Fixed TF sort, Process/Skip buttons, and highlighting
...
class TaggeristMainWindow(QMainWindow):
    ...
    def update_window_title(self):
        if self.current_file:
            self.setWindowTitle(f"Taggerist v33.05 - {os.path.basename(self.current_file)}")
        else:
            self.setWindowTitle("Taggerist v33.05")
...
class TaggeristList(QFrame):
    ...
    def setup_ui(self):
        ...
        with open('Taggerist_v33.05-buglog.txt', 'a') as debug_file:
        ...
        self.at_radio.setStyleSheet("color: #fff; background-color: #000; font-size: 16px;")
        self.copyright_radio.setStyleSheet("color: #fff; background-color: #000; font-size: 16px;")
        self.all_radio.setStyleSheet("color: #fff; background-color: #000; font-size: 16px;")
        self.at_radio.setFixedWidth(40)
        self.copyright_radio.setFixedWidth(40)
        self.all_radio.setFixedWidth(80)

        # Add buttons to the horizontal layout box
        radio_box.addWidget(self.at_radio)
        radio_box.addWidget(self.copyright_radio)
        radio_box.addWidget(self.all_radio)

        # Add radio_box to the layout
        layout.insertLayout(0, radio_box)
        ...
        self.all_radio.toggled.connect(lambda: self.update_date_prefix('(all)'))
...
class TaggeristFiles(QFrame):
    ...
    def handle_single_click(self, item):
        try:
            ...
            with open('Taggerist_v33.05-buglog.txt', 'a') as f:
