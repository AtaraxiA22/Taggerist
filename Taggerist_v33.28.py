...
# Taggerist v33.28: Rebuilt from v33.07 with v33.27 features (help button, config paths)
...
class TaggeristMainWindow(QMainWindow):
    ...
    def update_window_title(self):
        if self.current_file:
            self.setWindowTitle(f"Taggerist v33.28 - {os.path.basename(self.current_file)}")
        else:
            self.setWindowTitle("Taggerist v33.28")
...
class TaggeristList(QFrame):
    ...
    def setup_ui(self):
        ...
        with open('Taggerist_v33.28-buglog.txt', 'a') as debug_file:
...
class TaggeristFiles(QFrame):
    ...
    def handle_single_click(self, item):
        try:
            ...
            with open('Taggerist_v33.28-buglog.txt', 'a') as f:
