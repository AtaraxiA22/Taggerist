...
# Taggerist v33.29: Fixed NameError in TL setup_ui debug logging (undefined main_layout_name)
...
class TaggeristMainWindow(QMainWindow):
    ...
    def update_window_title(self):
        if self.current_file:
            self.setWindowTitle(f"Taggerist v33.29 - {os.path.basename(self.current_file)}")
        else:
            self.setWindowTitle("Taggerist v33.29")
...
class TaggeristList(QFrame):
    ...
    def setup_ui(self):
        ...
        with open('Taggerist_v33.29-buglog.txt', 'a') as debug_file:
...
class TaggeristFiles(QFrame):
    ...
    def handle_single_click(self, item):
        try:
            ...
            with open('Taggerist_v33.29-buglog.txt', 'a') as f:
