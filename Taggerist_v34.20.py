...
class TaggeristMainWindow(QMainWindow):
    def __init__(self):
        ...
        try:
            import PySide6
            with open('Taggerist_v34.19-buglog.txt', 'a') as f:
                f.write("--- Taggerist v34.19 startup ---\n")
    ...
    def apply_border_colors(self, color):
        self.setStyleSheet(f"""
            ...
            QProgressBar {{ background-color: #000; border: 1px solid {color}; color: #000; font-weight: bold; }}
        """)
    ...
    def update_window_title(self):
        if self.current_file:
            self.setWindowTitle(f"Taggerist v34.19 - {os.path.basename(self.current_file)}")
        else:
            self.setWindowTitle("Taggerist v34.19")
...
class TaggeristList(QFrame):
    ...
    def select_taglist(self, number):
        ...
        with open('Taggerist_v34.19-buglog.txt', 'a') as dbg:
    ...
    def apply_border_colors(self, color):
        ...
        self.length_bar.setStyleSheet(f"QProgressBar {{ background-color: #000; border: 1px solid {color}; color: #000; font-weight: bold; }} QProgressBar::chunk {{ background-color: #00cc00; }}")
    ...
    def setup_ui(self):
        layout = QVBoxLayout(self)
        with open('Taggerist_v34.19-buglog.txt', 'a') as debug_file:
        ...
        self.length_bar.setAlignment(Qt.AlignCenter)
        self.length_bar.setFormat("%v/255")
        self.length_bar.setFixedHeight(16)
        self.length_bar.setStyleSheet("QProgressBar { background-color: #000; border: 1px solid #FFFFCC; color: #000; font-weight: bold; } QProgressBar::chunk { background-color: #00cc00; }")
        ...
        clear_reduce_layout.addWidget(self.sort_tags_btn)
    ...
    def update_length_monitor(self):
        ...
        self.length_bar.setStyleSheet(
            f"QProgressBar {{ background-color: #000; border: 1px solid #FFFFCC; color: #000; font-weight: bold; }}"
