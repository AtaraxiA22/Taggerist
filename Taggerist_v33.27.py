...
# Taggerist v33.27: Fixed TF sort, Process/Skip buttons, and highlighting
...
class TaggeristMainWindow(QMainWindow):
    ...
    def update_window_title(self):
        if self.current_file:
            self.setWindowTitle(f"Taggerist v33.27 - {os.path.basename(self.current_file)}")
        else:
            self.setWindowTitle("Taggerist v33.27")
...
class TaggeristList(QFrame):
    ...
    def setup_ui(self):
        ...
        with open('Taggerist_v33.27-buglog.txt', 'a') as debug_file:
        ...
        # Row 1: Taglist choice buttons | Pathname | SKIP button | [?] button
        ...
        # Debug: Log main layout identification
        with open('Taggerist_v33.27-buglog.txt', 'a') as debug_file:
            debug_file.write('Debug: Placeholder for with block.\n')
    ...
    def setup_ui(self):
        ...
        # Debug: Log radio button creation
        with open('Taggerist_v33.06-buglog.txt', 'a') as debug_file:
            debug_file.write("Creating radio buttons in TaggeristList.setup_ui\n")
        # Create a horizontal layout box for @, ©, and (all) buttons at the top
...
class TaggeristFiles(QFrame):
    ...
    def handle_single_click(self, item):
        try:
            ...
            with open('Taggerist_v33.27-buglog.txt', 'a') as f:
