...
class TaggeristMainWindow(QMainWindow):
    def __init__(self):
        ...
        try:
            import PySide6
            with open('Taggerist_v35.08-buglog.txt', 'a') as f:
                f.write("--- Taggerist v35.08 startup ---\n")
    ...
    def update_window_title(self):
        if self.current_file:
            self.setWindowTitle(f"Taggerist v35.08 - {os.path.basename(self.current_file)}")
        else:
            self.setWindowTitle("Taggerist v35.08")
...
class TaggeristList(QFrame):
    ...
    def select_taglist(self, number):
        ...
        with open('Taggerist_v35.08-buglog.txt', 'a') as dbg:
    ...
    def setup_ui(self):
        layout = QVBoxLayout(self)
        with open('Taggerist_v35.08-buglog.txt', 'a') as debug_file:
